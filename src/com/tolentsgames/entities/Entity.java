...
public class Entity {
	...
	public static BufferedImage FLOR_EN = Game.spritesheet.getSprite(144, 32, 16, 16);
	public static BufferedImage BIGBOSS_EN = Game.spritesheet.getSprite(80, 32, 16, 16);
	public double x;
	public double y;
	protected int width;
