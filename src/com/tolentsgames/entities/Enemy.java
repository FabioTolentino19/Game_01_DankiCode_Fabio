...
/*		if(this.calculateDistance(this.getX(), this.getY(), Game.player.getX(), Game.player.getY()) < 40) {
		...
		//	} este if é para fazer a velocidade dos inimigos randômica está desabilitado
			} else {
			...
			//Aqui é o espaço para executar quando os inimigos estão distantes e não estão indo atras do player
			} */
		depth = 0;
